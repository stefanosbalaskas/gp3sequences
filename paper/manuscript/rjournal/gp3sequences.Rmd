...
knitr::kable(
  ...
  caption = "Planned integrated case-study workflow."
)
```
...
## Planned package analysis

The current manuscript branch establishes the data and analytical plan. The
next case-study milestone will execute the verified package workflow, freeze
all generated numerical outputs, and replace this planning subsection with
fully evaluated package code and interpretation.
...
The manuscript currently uses a deterministic synthetic case study and does
not yet report frozen end-to-end analytical results. Some specialist
capabilities are available only through optional packages, and documented
absence in reviewed sources is not equivalent to proof of nonexistence.
Submission also remains gated on a stable CRAN release matching the version
